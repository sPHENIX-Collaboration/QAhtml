...
echo $$ > htmlrunning
source /sphenix/user/jlnliu/QAhtml/makehtml/setup_all.sh
Xvfb :2 -nolisten tcp &
export DISPLAY=unix:2

for i in /sphenix/tg/tg01/jets/vbailey/run25_jet_hists/new_newcdbtag_v005/HIST_JETQA-000676*.root; do
