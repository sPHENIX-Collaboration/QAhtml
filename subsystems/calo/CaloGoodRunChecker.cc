...
{  
  ...
  if (!ref_hfile || ref_hfile->IsZombie())
  ...
  else
    {
      ...
      calo->FindHot(ref_histfile, ref_outfile_cemc, "h_CaloValid_cemc_etaphi");
      calo->FindHot(ref_histfile, ref_outfile_ihcal, "h_CaloValid_ihcal_etaphi");
      calo->FindHot(ref_histfile, ref_outfile_ohcal, "h_CaloValid_ohcal_etaphi");
