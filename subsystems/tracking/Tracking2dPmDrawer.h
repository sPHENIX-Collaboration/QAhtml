#ifndef TRACKING_2D_PM_DRAWER_H
#define TRACKING_2D_PM_DRAWER_H
...
class Tracking2dPmDrawer : public SingleCanvasDrawer
{
public:
	Tracking2dPmDrawer (std::string const&);
	virtual ~Tracking2dPmDrawer();
