...
# This script is the main entry point to the HTML Output from the sPHENIX QA
...
sub help {
  ...
  print "This script is intended to navigate Online Production QA <BR>\n";
...
sub show_contacts {
  ...
  my %list = ( 
	      "Master of the beast" => {
		       name => "Nathan Grau",
		       email => "ngrau\@augie.edu",
		       photo => "sphenix-logo-white-bg.png",
		      },
	      "QA infra structure" => {
		     name => "Joe Osborn",
		     email => "josborn1\@bnl.gov",
		     photo => "sphenix-logo-white-bg.png"
		    }
	     );
